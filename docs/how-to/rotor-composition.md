...
is $R_2R_1$. Order matters: to reproduce sequential actions, multiply the rotors directly. Bivectors in different planes generally do not commute, so in general exponentiating their sum does not reproduce the sequential transformation.
