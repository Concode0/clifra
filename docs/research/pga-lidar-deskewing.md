...
defined analytic translating and rotating trajectory. The optimizer does not
receive that trajectory. It sees 1,160 timed returns and 183 sparse geometric
constraints: 104 point-plane incidences, 60 point-line distances, and surveyed
point anchors.
...
The indexed inverse round trip is \(4.4\times10^{-15}\). The ground-truth
trajectory and simulation oracle are used only for synthesis and evaluation,
not by the optimization objective.
...
```text
setup         1160 timed returns | 183 sparse constraints | 10 RBF controls | seed 29
...
numerical    pose 3.03 cm / 1.036° | inverse 4.4e-15
optimization best 2.126e-03 at 747 | final 2.126e-03 | 183 constraints
```
