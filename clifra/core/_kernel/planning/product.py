...
``clifra.core._kernel.execution.product``.
"""
...
class GradeProductPlan:
    ...
    def __init__(
        ...
        *,
        ...
        self.left_contract = TensorContract.compact(self.left_layout)
        self.right_contract = TensorContract.compact(self.right_layout)
    ...
    *,
    ...
    if op == "left_contraction":
        ...
        if op == "commutator_product":
            ...
            valid = valid & ~parity_odd
    elif op not in {"geometric_product", "wedge"}:
