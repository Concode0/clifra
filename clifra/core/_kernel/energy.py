...
from clifra.core._kernel.contracts import compact_pair_values, compact_values
from clifra.core.layout import GradeLayout


def lane_dot_product(
    algebra, A: torch.Tensor, B: torch.Tensor, *, layout: Optional[GradeLayout] = None, grades=None
) -> torch.Tensor:
...
def lane_grade_energy(
    algebra, values: torch.Tensor, *, layout: Optional[GradeLayout] = None, grades=None
) -> torch.Tensor:
