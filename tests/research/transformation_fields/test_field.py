...
def test_engine_uses_persistent_sample_labels_for_inverse_diagnostics():
    ...
    engine = TransformationFieldEngine(field, geometric_policies=(InvertiblePathConsistencyPolicy(),))
    evaluation = engine.evaluate(CoordinateFieldInput(coordinates, sample_coordinates=labels))
